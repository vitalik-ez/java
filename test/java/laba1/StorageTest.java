...
class StorageTest {
    ...
    public void init() {
        ...
        Maker maker_1 = new Maker("CP Company - Berlin");
        Maker maker_2 = new Maker("Adidas - Berlin");
    ...
    void getTotalCostJackets_True_ifTotalCostJacketsIsRight() {
        ...
        assertEquals( 900, storage.getTotalCostJackets());
    }
    ...
    @Test
    void getTheMostPopularNameMake_True_IfNameIsRight() {
        Storage storage = new Storage(outerwears);
